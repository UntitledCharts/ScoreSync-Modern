...
2. Create a new folder (with any name) inside the levels directory, and add a .sus/.usc/LevelData/.mmws/.ccmmws/.unchmmws file, a .mp3, and a .png file into it.
...
譜面ファイル（.sus / .usc / LevelData / .mmws / .ccmmws / .unchmmws のいずれか1つ）、
